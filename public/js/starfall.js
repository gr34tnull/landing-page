...
function Particle(x, y, dx, dy) {
    ...
    this.draw = function() {
        c.save();
        c.fillStyle = "rgba(244, 244, 229," + this.opacity + ")";
        c.shadowColor = '#E3EAEF';
        c.shadowBlur = 20;
        c.shadowOffsetX = 0;
        c.shadowOffsetY = 0;
...
function animate() {
    ...
    createMountainRange(1, canvas.height - 50, "#F2F2E6");
    createMountainRange(2, canvas.height - 100,  "#A9AAA3");
    createMountainRange(3, canvas.height - 300 , "#696969");
